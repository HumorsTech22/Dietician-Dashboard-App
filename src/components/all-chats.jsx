...
//     { name: "lorem", message: "Another sample message that is too long and needs trimming..." },
//     { name: "Manoranjan", message: "Another sample message that is too long and needs trimming..." },
//     { name: "Manoranjan", message: "Another sample message that is too long and needs trimming...", badgeCount: 2 },
//     { name: "Manoranjan", message: "Another sample message that is too long and needs trimming...", badgeCount: 2 },
//     { name: "Manoranjan", message: "Another sample message that is too long and needs trimming...", badgeCount: 2 },
//     { name: "Manoranjan", message: "Another sample message that is too long and needs trimming...", badgeCount: 2 },
...
//         <div className="flex-1 overflow-y-auto max-h-[calc(19*64px)]">
      ...
      <div className="h-[80vh] flex flex-col">
        <div className="rounded-t-[15px] bg-white">
          <div className="ml-[15px] mt-[25px]">
            <p className="text-[#252525] text-[15px] font-semibold tracking-[-0.3px] leading-[110%]">All Chats</p>
          </div>
          <div>
            <UserProfile />
          </div>
