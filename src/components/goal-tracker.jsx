...
//                 <span className="text-[#252525] font-bold text-[20px] leading-normal tracking-[-0.4px]">
//                   30 plans
//                 </span>
//                 <div className="flex flex-col">
//                   <span className="text-[#252525] font-normal text-[12px] leading-normal tracking-[-0.24px] whitespace-nowrap">
//                     Total Assigned
//                   </span>
//                   <span className="text-[#252525] font-normal text-[12px] leading-normal tracking-[-0.24px] whitespace-nowrap">
    ...
    <>
      <div className="flex gap-5 bg-white rounded-[15px] pt-[15px] pb-[18px] pr-5">
        ...
        <div className="flex-1 flex flex-col gap-7">
          <DashboardCard activeTab={activeTab} />
