...
export default function DeletePopUp({ open, onClose }) {
  ...
  Once deleted, all meal schedules for this plan will be <br /> permanently deleted
                        ...
                        <div className="flex items-center justify-center gap-[37px]">
                            <button className="w-[146px] bg-[#D9D9D9] hover:bg-[#c4c4c4] px-5 py-[15px] rounded-[10px] text-[#252525] text-[12px] font-semibold leading-normal tracking-[-0.24px] cursor-pointer transition-colors duration-200">Edit</button>
