...
//     return (
//         <>
//             <div className="w-full px-[10px] bg-white rounded-[15px]">
...
//                         <p className="text-[#252525] text-[15px] font-semibold leading-[1.26] tracking-[-0.3px]">Sagar Hosur </p>
//                         <p className="text-[#535359] text-[10px] font-normal leading-[normal] tracking-[-0.2px]">Active Now</p>
//                     </div>

//                 </div>

//                 <div className="flex bg-[#F3FFF5] py-2 px-2.5 rounded-[15px]">
...
//                             <p className="text-[#3FAF58] text-[12px] font-semibold leading-[126%] tracking-[-0.24px]
// ">Active</p>
//                         </div>

//                         <div className="flex gap-[5px]">
//                             <p className="text-[#308BF9] [leading-trim:both] [text-edge:cap] font-['Poppins'] text-[12px] not-italic font-semibold leading-[110%] tracking-[-0.24px]">View plan</p>
...
//                             <p className="text-[#252525] text-[12px] font-semibold leading-[1.26] tracking-[-0.24px]">Weight Loss | PCOS Management</p>
//                         </div>
//                     </div>
//                 </div>
    ...
    return (
        <>
            ...
            <div className="w-full px-[10px] bg-white rounded-[15px] flex flex-col h-[80vh]">
                ...
                {/* Plan bar */}
                <div className="flex bg-[#F3FFF5] py-2 px-2.5 rounded-[15px] mx-[10px] mb-[12px]">
                    <div className="w-[333px] flex gap-[42px] items-center">
                        <div className="flex gap-[5px]">
                            <p className="text-[#535359] text-[12px] font-normal leading-[1.26] tracking-[-0.24px]">Plan Status:</p>
                ...
                {/* Messages (scrollable) */}
                <div className="flex flex-col gap-3 w-full flex-1 overflow-y-auto pr-2">
                    {/* Left message */}
                    <div className="flex justify-start">
                        <div className="w-[312px] flex flex-col rounded-[8px] py-2.5 pl-[15px] pr-[42px] bg-[#EAF3FF]">
                            <p className="text-[#252525] text-[12px] font-normal leading-[normal] tracking-[-0.24px]">
