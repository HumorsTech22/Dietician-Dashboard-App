...
// {(open || showUploadModal) && (
//        <div className="fixed inset-0 flex justify-center  items-center z-[10000] pointer-events-none">
//     <div className="relative flex gap-2 pointer-events-none">

//       {/* actual popup */}
//       <div className="pointer-events-auto">
//         {/* popup gets rendered here normally */}
//       </div>

//       {/* close button */}
//       <button
//         className="pointer-events-auto bg-white text-black px-3 py-1 rounded-md shadow translate-x-3 cursor-pointer"
//         onClick={onClose}
//       >
//         x
//       </button>
...
//         >
//           <div
//             className="bg-white w-[90%] max-w-[620px] rounded-[10px] p-0"
...
//           >
//             <div className="flex gap-6 pt-[50px] px-8 pb-8">
//               <div className="max-w-[236px] flex flex-col gap-3">
//                 <span className="text-[#252525] text-[15px] font-semibold">
//                   Create new plan
//                 </span>
//                 <p className="text-[#252525] text-[34px] leading-[110%]">
...
//               {/* UPLOAD BOX */}
//               <div
//                 className={`flex-1 border-2 border-dashed rounded-[10px] p-8 text-center
//                 ${
//                   fileSizeError
//                     ? "border-[#DA5747] bg-[#FFF5F5]"
//                     : "border-[#E1E6ED]"
