...
//           { color: "#FFC412", width: "10%" },
//           { color: "#DA5747", width: "70%" },
//         ];

//       case "absorptive":
//         return [
//           { color: "#DA5747", width: "50%" },
...
//     if (hasPoor) return "#DA5747";
//     if (hasFair) return "#FFC412";
//     if (hasGood) return "#3FAF58";
...
function TrendsComponent({ selectedDate, showMainMarker = true, compactGraphs = false }) {
  ...
  const getTabColor = (tabLabel) => {
    ...
    if (z1 === "poor" || z2 === "poor") return "#DA5747";
    if (z1 === "fair" || z2 === "fair") return "#FFC412";
    if (z1 === "good" || z2 === "good") return "#3FAF58";
