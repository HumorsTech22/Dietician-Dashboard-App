...
function DietPlanTableCell({ dayNumber }) {
  return (
    <td className="border border-[#D9D9D9] px-[15px] py-[15px] align-top min-w-[340px]">
          ...
          <div className="flex flex-col gap-[15px]">
            ...
            <div className="pt-[54px] bg-[#F5F7FA] rounded-[15px]">
              ...
              <div className="mt-4 mx-[15px] overflow-x-auto">
                <table className="min-w-full border border-[#E1E6ED] border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr className="w-full">
                      {days.map((day) => (
                        <DietPlanTableCell key={day} dayNumber={day} />
                      ))}
                    </tr>
                  </tbody>
                </table>
